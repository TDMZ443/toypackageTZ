...
The goal of `toypackageTZ` is to provide convenience functions for some common tasks.

## Installation

You can install the development version of `toypackageTZ` from [GitHub](https://github.com/) with:
